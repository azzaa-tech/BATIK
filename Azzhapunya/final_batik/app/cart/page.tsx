  ...
  return (
    <div className="min-h-screen bg-white pt-28 px-4 py-8 pb-28 font-['Segoe_UI']">
      ...
      <div className="mx-auto mb-5 flex max-w-[960px] items-center gap-[10px]">
        ...
        <h1 className="m-0 text-[20px] font-bold text-[#7b1d1d]">
          Keranjang Belanja
        </h1>
      ...
      <div className="mx-auto flex max-w-[960px] flex-wrap items-start gap-5">
        ...
        <div className="flex-[1_1_480px]">
          <div className="rounded-[20px] bg-[#f8f0e0] p-7 w-250 shadow-[0_6px_25px_rgba(0,0,0,0.12)]">
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="mb-[4px] text-[15px] font-bold text-[#2d0000]">
                        {item.nama}
                      </p>

                      <p className="mb-[6px] text-[13px] text-[#999]">
                        Ukuran: {item.size}
                      </p>

                      <p className="text-[16px] font-bold text-[#7b1d1d]">
                        {format(item.harga)}
                      </p>
                    </div>
        ...
        <div className="min-w-[280px] flex-[0_0_300px]">
          ...
          <div className="rounded-[20px] bg-[#f7f7f7] p-7 shadow-[0_6px_25px_rgba(0,0,0,0.12)]">
            ...
            <div className="mb-[8px] flex gap-2">
              ...
              <button
                onClick={applyPromo}
                className="cursor-pointer rounded-[12px] border-none bg-[#7b1d1d] px-[16px] text-[14px] font-semibold text-white"
              >
                Apply
              </button>
